    ...
    public static class Iteration
    {
        ...
        */
        ...
        public static IEnumerable<string> Yelling(List<string> words)
        {
            ...
            // var wordsUpper = words.Select(word => word.ToUpper());
            // return wordsUpper;
            // throw new System.NotImplementedException();
        }
        ...
        {
            return sentences.IndexOf(sentences.FirstOrDefault(sentence => sentence.Contains("needle")));
            // var needle = sentences.FirstOrDefault(sentence => sentence.Contains("needle"));
            // return sentences.IndexOf(needle);
            // throw new System.NotImplementedException();
        }
